Public Class Euclides
    ...
    Private Sub UltraButton1_Click(sender As Object, e As EventArgs) Handles UltraButton1.Click
        ...
        Dim N As Integer = (Recursividad.Principal.Instancia.MCD(UltraNumericEditor1.Value, UltraNumericEditor2.Value))
        Me.UltraFormattedTextEditor1.Text = UltraFormattedTextEditor1.Text + "******************************" + vbNewLine + "MCD(" + UltraNumericEditor1.Value.ToString + "," + UltraNumericEditor2.Value.ToString + ") = " + N.ToString + vbNewLine + "******************************"
        DataGridView1.Rows.Add("MCD(" + UltraNumericEditor1.Value.ToString + "," + UltraNumericEditor2.Value.ToString + ")", N.ToString)
    End Sub
