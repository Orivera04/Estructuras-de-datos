    ...
    public partial class Arboles : Form
    {
        ...
        public void Dibujar(int Parametro,int[] Cola = null,bool Dibujar = false,int Verde = 0)
       {
        ...
        private void ultraButton15_Click(object sender, EventArgs e)
        {
            try
            {
                Process.Start("Documentos\\AED-Arboles.docx");
            }
            catch
            {
        ...
        private void ultraButton16_Click(object sender, EventArgs e)
        {
            try
            {
                Process.Start("Documentos\\Arboles Final.mp4");
            }
            catch
            {
                MessageBox.Show("Error : El archivo no existe", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public string Inorden(Clase_Arboles Nodo,int Parametro,int [] Cola = null,bool Dibu = false)
        {
            ...
            {
                if (Cola == null) { 
                ListViewItem Lista = new ListViewItem(Convert.ToString(Nodo.Dato));                
                ...
                Lista.SubItems.Add((Instancia.Nivel(Nodo.Dato)+1).ToString());
                    ...
                    if(Nodo.Enlace_Derecho == null && Nodo.Enlace_Izquierdo == null)
                    {
                        Lista.SubItems.Add("No tiene");
                    }
                    else if(Nodo.Enlace_Derecho  != null && Nodo.Enlace_Izquierdo == null)
                    {
                        Lista.SubItems.Add(Nodo.Enlace_Derecho .Dato.ToString());
                    }
                    else if (Nodo.Enlace_Izquierdo  != null && Nodo.Enlace_Derecho  == null)
                    {
                        Lista.SubItems.Add(Nodo.Enlace_Izquierdo.Dato.ToString());

                    }
                    else
                    {
                        Lista.SubItems.Add(Nodo.Enlace_Izquierdo.Dato.ToString() + "," + Nodo.Enlace_Derecho.Dato.ToString());

                    }
                    if (Nodo.Padre  != null)
                    {
                        if (Nodo.Padre.Enlace_Derecho != null || Nodo.Padre.Enlace_Izquierdo != null)
                        {
                            if (Nodo.Padre.Enlace_Derecho != null && (Nodo.Padre.Enlace_Izquierdo != null && Nodo.Padre.Enlace_Izquierdo.Equals(Nodo)))
                            {
                                if (Nodo.Padre.Enlace_Derecho.Dato != Nodo.Dato)
                                {
                                    Lista.SubItems.Add(Nodo.Padre.Enlace_Derecho.Dato.ToString());
                                }
                                else
                                {
                                    Lista.SubItems.Add("No tiene");
                            ...
                            {
                                if (Nodo.Padre.Enlace_Izquierdo != null &&Nodo.Padre.Enlace_Izquierdo.Dato != Nodo.Dato)
                                {
                                    Lista.SubItems.Add(Nodo.Padre.Enlace_Izquierdo.Dato.ToString());
                                }
                                else
                                {
                                    Lista.SubItems.Add("No tiene");
